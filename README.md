...
---
- **[Interactive Dashboard](https://github.com/Amit-DataDoc23/Super-Store-Sales-Dashboard/blob/0bceff3b9b7a4d9b4988f3e0a4e5b2dc3a7a691a/SuperStore%20Dashboard.png)**  
...
## Insights
- Standard Class dominates shipping with ~58% of sales.  
- November shows peak demand with 3,039 units ordered.  
- New York leads city-wise sales, crossing 6.5 lakh.  
- Office Supplies category contributes the highest transactions.  
- Consumer segment drives majority of orders compared to Corporate and Home Office.  

---

## Tech Stack
- **Excel** (Dashboard creation, charts, slicers)  
